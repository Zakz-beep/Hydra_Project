                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className={`text-xl font-mono font-bold ${zeroDte.net_gex_spotgamma >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                                        {formatBillion(zeroDte.net_gex_spotgamma)}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className={`text-xl font-mono font-bold ${zeroDte.net_vanna >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                                        {formatMillion(zeroDte.net_vanna)}
                                    </p>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className={`text-xl font-mono font-bold ${zeroDte.net_charm >= 0 ? 'text-emerald-400' : 'text-red-400'}`}>
                                        {formatMillion(zeroDte.net_charm)}
                                    </p>
                                </div>
                                <div>
                        ...
                        {activeTab === 'LEVELS' && (
                            <div className="space-y-3">
                                <div className="flex justify-between items-center mb-2">
                                    ...
                                    <p className="text-[10px] font-mono text-zinc-500 uppercase">Spot: <span className="text-zinc-300">${data.spot?.toFixed(2)}</span></p>
                                </div>
                                {strikes.length === 0 ? (
                                    ...
                                    strikes.map((s, idx) => {
                                        ...
                                        return (
                                            <div key={idx} className="flex items-center justify-between bg-zinc-900/50 border border-zinc-800/50 p-2 rounded-lg">
