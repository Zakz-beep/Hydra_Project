  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <div className="rounded-xl border border-zinc-800/60 bg-zinc-900/50 p-4">
        <h3 className="text-xs font-mono text-zinc-400 uppercase tracking-wider mb-2">Net GEX History</h3>
        <ResponsiveContainer width="100%" height={200}>
          <LineChart data={formattedData} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
            ...
            <Line type="monotone" dataKey="total_net_gex" name="Net GEX" stroke="#34d399" strokeWidth={2} dot={false} activeDot={{ r: 3, fill: "#34d399" }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
